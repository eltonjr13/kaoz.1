 ...
 */
import { ReservoirError, sparseMatVec, } from "./sparse-reservoir.mjs";
/**
 ...
 */
export function scoreWithReadout(id, features, readout) {
    if (features.length !== readout.dimension) {
        throw new ReservoirError("dimension", `readout espera ${readout.dimension} features, recebidas ${features.length}`);
    }
 ...
 */
export function projectInput(projection, input, out) {
