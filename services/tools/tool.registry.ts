...
const nativeTools:KaozTool[]=[
 ...
 {id:"davinci-free:analyze-intelligent",name:"Analisar aula por áudio",description:"Segmenta e transcreve o áudio localmente e cria decisões semânticas de edição.",source:"native",inputSchema:{type:"object",required:["requestId","sourcePath","moduleName"],properties:{requestId:{type:"string"},sourcePath:{type:"string"},courseName:{type:"string"},moduleName:{type:"string"},style:{type:"string",enum:["subtle","balanced","dynamic"]},musicPath:{type:"string"},musicDb:{type:"number"},useAgent:{type:"boolean"}}},effect:"write",approvalMode:"step",timeoutMs:600_000,enabled:true},
