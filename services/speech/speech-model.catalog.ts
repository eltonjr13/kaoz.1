...
export const SPEECH_MODEL_CATALOG: readonly SpeechModelDefinition[] = [
  ...
  whisperModel({ id: "whisper-small-en", name: "Whisper Small English", description: "Modelo intermediario exclusivo para ingles.", fileName: "ggml-small.en.bin", checksum: { algorithm: "sha1", value: "db8a495a91d927739e50b3fc1cc4c6b8f6c2d022" }, sizeBytes: 466 * MIB, memoryBytes: 852 * MIB, multilingual: false, quantized: false, quality: "high" }),
  ...
  whisperModel({ id: "whisper-medium", name: "Whisper Medium", description: "Alta precisao multilíngue.", fileName: "ggml-medium.bin", checksum: { algorithm: "sha1", value: "fd9727b6e1217c2f614f9b698455c4ffd82463b4" }, sizeBytes: 1.5 * GIB, memoryBytes: 2.1 * GIB, multilingual: true, quantized: false, quality: "highest" }),
