...
export default function ModelViewer3D({ src, alt = "Objeto 3D", title }: ModelViewer3DProps) {
  ...
  return (
    <>
      {/* Standard Embed View */}
      <div className="relative group w-full rounded-2xl overflow-hidden border border-white/10 bg-[#0a0a0f]/90 aspect-square flex flex-col items-center justify-center">
        {/* Title Tag */}
        {title && (
        ...
        <div className="absolute bottom-3 left-1/2 -translate-x-1/2 z-10 flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-black/75 backdrop-blur-md border border-white/10 shadow-lg opacity-90 group-hover:opacity-100 transition-opacity duration-300">
          <button
            type="button"
